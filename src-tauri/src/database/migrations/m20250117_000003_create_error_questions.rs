        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .if_not_exists()
                    .col(
                        ColumnDef::new(ErrorQuestions::Id)
                            .string()
                            .not_null()
                            .primary_key(),
                    )
                    ...
                    .col(
                        ColumnDef::new(ErrorQuestions::Subjectid)
                            .string()
                            .not_null(),
                    )
                    ...
                    .col(
                        ColumnDef::new(ErrorQuestions::CreatedAt)
                            .big_integer()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(ErrorQuestions::UpdatedAt)
                            .big_integer()
                            .not_null(),
                    )
                    .col(ColumnDef::new(ErrorQuestions::DeletedAt).big_integer())
                    .col(
                        ColumnDef::new(ErrorQuestions::Version)
                            .integer()
                            .not_null()
                            .default(0),
                    )
                    .col(
                        ColumnDef::new(ErrorQuestions::SyncStatus)
                            .string()
                            .not_null()
                            .default("synced"),
                    )
