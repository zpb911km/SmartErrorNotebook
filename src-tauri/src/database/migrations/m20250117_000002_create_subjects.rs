        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .if_not_exists()
                    .col(ColumnDef::new(Subjects::Id).string().not_null().primary_key())
                    ...
                    .col(ColumnDef::new(Subjects::Version).integer().not_null().default(0))
                    .col(ColumnDef::new(Subjects::SyncStatus).string().not_null().default("synced"))
