        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .if_not_exists()
                    .col(ColumnDef::new(UserConfig::Username).string().not_null().primary_key())
                    ...
                    .col(ColumnDef::new(UserConfig::Sync).boolean().not_null().default(false))
                    .col(ColumnDef::new(UserConfig::CreatedAt).big_integer().not_null())
                    .col(ColumnDef::new(UserConfig::UpdatedAt).big_integer().not_null())
                    .to_owned(),
            )
            .await
    }
