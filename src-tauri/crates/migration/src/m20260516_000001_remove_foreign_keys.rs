    ...
    manager
        .create_table(
            Table::create()
                ...
                .col(
                    ColumnDef::new(EqCols::Version)
                        .integer()
                        .not_null()
                        .default(0),
                )
                .col(
                    ColumnDef::new(EqCols::SyncStatus)
                        .string()
                        .not_null()
                        .default("synced"),
                )
    ...
    manager
        .create_table(
            Table::create()
                .table(Alias::new(&format!("{}_new", table)))
                .col(
                    ColumnDef::new(SrsCols::Id)
                        .string()
                        .not_null()
                        .primary_key(),
                )
                .col(
                    ColumnDef::new(SrsCols::QuestionId)
                        .string()
                        .not_null()
                        .unique_key(),
                )
                .col(
                    ColumnDef::new(SrsCols::Stability)
                        .float()
                        .not_null()
                        .default(3.0),
                )
                .col(
                    ColumnDef::new(SrsCols::Difficulty)
                        .float()
                        .not_null()
                        .default(2.5),
                )
                ...
                .col(
                    ColumnDef::new(SrsCols::ReviewCount)
                        .integer()
                        .not_null()
                        .default(0),
                )
                .col(
                    ColumnDef::new(SrsCols::FeedbackHistory)
                        .string()
                        .not_null()
                        .default("[]"),
                )
                ...
                .col(
                    ColumnDef::new(SrsCols::Version)
                        .integer()
                        .not_null()
                        .default(0),
                )
                .col(
                    ColumnDef::new(SrsCols::SyncStatus)
                        .string()
                        .not_null()
                        .default("synced"),
                )
    ...
    manager
        .create_table(
            Table::create()
                ...
                .col(
                    ColumnDef::new(TagCols::Version)
                        .integer()
                        .not_null()
                        .default(0),
                )
                .col(
                    ColumnDef::new(TagCols::SyncStatus)
                        .string()
                        .not_null()
                        .default("synced"),
                )
    ...
    manager
        .create_table(
            Table::create()
                ...
                .col(
                    ColumnDef::new(AttCols::Version)
                        .integer()
                        .not_null()
                        .default(0),
                )
                .col(
                    ColumnDef::new(AttCols::SyncStatus)
                        .string()
                        .not_null()
                        .default("synced"),
                )
...
async fn copy_and_swap(
    ...
    let sql = format!(
        ...
        new, columns, columns, table_name
    );
